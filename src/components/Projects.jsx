...
const Projects = () => {
  ...
  id: 4,
  title: "CityPulse",
  subtitle: "Smart City Dashboard (In Progress)",
  description: "CityPulse is a smart city dashboard aimed at visualizing live urban data, improving civic management, and empowering authorities and citizens with real-time insights. The platform will integrate interactive charts, pollution data, utilities, and emergency alerts.",
  features: [
    "Live air quality & pollution monitoring",
    "Real-time water & electricity usage tracking",
    "Emergency alert systems",
    "Admin & Citizen portals",
    "Dynamic charts and visualizations"
  ],
  techStack: ["React.js", "Tailwind CSS", "Node.js", "Express.js", "MongoDB", "Chart.js", "Socket.io"],
  icon: <MapPin className="text-yellow-500" size={32} />,
  githubUrl: "https://github.com/MANOJRAJPUT2065/CityPulse",
  liveUrl: "#"
}
